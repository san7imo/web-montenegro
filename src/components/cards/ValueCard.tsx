...
export function ValueCard({ title, description, icon }: ValueCardProps) {
  return (
    <article className="flex h-full flex-col rounded-[2.7rem] bg-white/[0.045] px-8 py-10 shadow-[0_12px_26px_rgba(24,35,28,0.1)] ring-1 ring-black/3 backdrop-blur-[1px] sm:px-9 sm:py-11">
      <h3 className="text-center font-heading text-[2.5rem] leading-none tracking-[-0.035em] text-cream-light sm:text-[2.8rem]">
        {title}
      </h3>
      ...
      <p className="mt-7 text-center text-[1rem] leading-8 text-cream-light/92 sm:text-[1.06rem] sm:leading-9">
        {description}
      </p>
    </article>
  )
