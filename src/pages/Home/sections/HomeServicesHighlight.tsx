        ...
        <Container className="flex w-full">
          <div className="ml-auto flex w-full max-w-[22rem] flex-col items-start sm:max-w-[30rem] lg:max-w-[40rem] lg:items-end lg:pt-0">
            <motion.div {...fadeUp(0.08)}>
              <SectionLabel
                variant="dark"
                className="border-pink-soft/58 bg-pink-soft/12 px-4 tracking-[0.04em] text-pink-soft shadow-[0_12px_30px_rgba(194,11,114,0.08)] sm:px-5"
              >
            ...
            <motion.div className="mt-5 sm:mt-6 lg:mt-7" {...fadeUp(0.2)}>
              <SectionTitle
                as="h2"
                className="max-w-[13ch] text-left text-cream-light drop-shadow-[0_12px_24px_rgba(20,29,24,0.14)] sm:max-w-[14ch] lg:max-w-none lg:text-right"
              >
            ...
            <motion.div className="mt-7 sm:mt-8 lg:mt-9" {...fadeUp(0.34)}>
              <Button
                ...
                variant="outline"
                showArrow
                className="min-w-[12rem] border-pink-soft/72 bg-pink-soft/10 px-7 text-pink-soft shadow-[0_14px_36px_rgba(194,11,114,0.1)] hover:border-pink-soft hover:bg-pink-soft/16 hover:text-pink-soft"
              >
